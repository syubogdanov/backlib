...
from backlib.internal.backports.py313.json.src import scanner
...
def scanstring(s: str, end: int, strict: bool = True) -> tuple[str, int]:  # noqa: C901, FBT001, FBT002
...
def JSONObject(  # noqa: C901, N802, PLR0912, PLR0915
