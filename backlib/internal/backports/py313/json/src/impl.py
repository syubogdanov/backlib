...
from backlib.internal.backports.py313.json.src.decoder import JSONDecodeError, JSONDecoder
from backlib.internal.backports.py313.json.src.encoder import JSONEncoder
