...
from backlib.py313.internal.backports.errno import EAGAIN
...
from backlib.py313.internal.backports.os import SEEK_CUR, SEEK_DATA, SEEK_END, SEEK_HOLE, SEEK_SET
from backlib.py313.internal.markers import ruff, techdebt
...
if TYPE_CHECKING:
    ...
    from backlib.py313.internal.backports.collections_abc import Buffer
...
class RawIOBase(BinaryIOBase):
    ...
    * Python 3.13.
    ...
    def readinto(self: Self, buffer: Buffer, /) -> int | None:
    ...
    def write(self: Self, buffer: Buffer, /) -> int | None:
...
class BufferedIOBase(BinaryIOBase):
    ...
    * Python 3.13.
    ...
    def readinto1(self: Self, buffer: Buffer, /) -> int | None:
    ...
    def write(self: Self, buffer: Buffer, /) -> int:
    ...
    def _readinto(self: Self, buffer: Buffer, *, read1: bool) -> int | None:
        """Read bytes into a pre-allocated, writable bytes-like object."""
...
class BytesIO(BufferedIOBase):
    ...
    * Python 3.13.
    ...
    def __init__(self: Self, initial_bytes: Buffer | None = None) -> None:
        """Initialize the object.
...
class BufferedReader(BufferedIOMixin):
    ...
    * Python 3.13.
    ...
    @techdebt.refactor
    def _readinto(self: Self, buffer: Buffer, *, read1: bool) -> int:  # noqa: C901
        """Read bytes into a pre-allocated, writable bytes-like object."""
        if self.raw is None:
