...
from backlib.py313.internal.backports.json.internal.decoder import JSONDecodeError, JSONDecoder
...
if TYPE_CHECKING:
    ...
    from backlib.py313.internal.backports.json.internal.typing import SupportsRead, SupportsWrite
...
def detect_encoding(b: bytes | bytearray) -> str:  # noqa: D103, PLR0911
