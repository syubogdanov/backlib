...
from backlib.py313.internal.backports.ntpath.internal.utils import check_arg_types, is_reserved_name
...
from backlib.py313.internal.backports.stat import (
...
def join(path: AnyStr | PathLike[AnyStr], *paths: AnyStr | PathLike[AnyStr]) -> AnyStr:
    ...
    * Python 3.13.
    ...
    try:
        ...
        if result_path and not result_root and result_drive and result_drive[-1] not in colon_seps:
