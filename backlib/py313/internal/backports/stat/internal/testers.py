from backlib.py313.internal.backports.stat.internal.masks import (
    S_IFBLK,
    S_IFCHR,
    S_IFDIR,
    S_IFIFO,
...
@techdebt.simplified
def S_ISDOOR(mode: int) -> bool:  # noqa: N802
...
@techdebt.simplified
def S_ISPORT(mode: int) -> bool:  # noqa: N802
...
@techdebt.simplified
def S_ISWHT(mode: int) -> bool:  # noqa: N802
