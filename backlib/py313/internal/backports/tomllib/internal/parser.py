...
from backlib.py313.internal.backports.tomllib.internal.re import (
    RE_DATETIME,
    RE_LOCALTIME,
    RE_NUMBER,
    match_to_datetime,
...
if TYPE_CHECKING:
    ...
    from backlib.py313.internal.backports.tomllib.internal.types import Key, ParseFloat, Pos
    from backlib.py313.internal.backports.tomllib.internal.typing import SupportsRead
...
def parse_inline_table(  # noqa: D103
    src: str,
    pos: Pos,
    parse_float: ParseFloat,
) -> tuple[Pos, dict]:
